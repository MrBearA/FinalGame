...
[RequireComponent(typeof(Rigidbody2D), typeof(TouchingDirection), typeof(Damagaeable))]
public class FierceTooth : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        damagaeable = GetComponent<Damagaeable>();
    }
